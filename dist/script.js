...
function checkForHighLatency(player) {
  ...
  if (player.getLiveLatency() > liveLatencyThreshold) {
    ...
    console.log(`Live edge ${liveEdge}, currentTime: ${videoEl.currentTime}`);
...
(function (IVSPlayerPackage) {
  ...
  player.load(
    "https://199d174ba4fa.us-east-1.playback.live-video.net/api/video/v1/us-east-1.629272321014.channel.Zy6MoOcNQ3Ul.m3u8"
  );
